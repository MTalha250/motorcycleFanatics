  ...
  return (
    <div className="container fixed top-3 z-30 w-full">
      ...
      <div className="lg:hidden text-white font-bold text-2xl">LOGO</div>
        ...
        <button className="hidden lg:flex bg-primary py-2 px-6 text-white rounded-xl text-lg font-semibold">
          Register
        </button>
        ...
        <button className="hidden lg:flex bg-white py-2 px-6 text-primary rounded-xl text-lg font-semibold">
          Log In
        </button>
      ...
      >
        ...
        <div className="flex mt-8 space-x-4">
          <button className="bg-primary py-2 px-4 w-1/2 text-white rounded-xl text-lg font-semibold">
            Register
          </button>
          <button className="bg-white py-2 px-4 w-1/2 text-primary rounded-xl text-lg font-semibold">
            Log In
          </button>
        </div>
      </div>
