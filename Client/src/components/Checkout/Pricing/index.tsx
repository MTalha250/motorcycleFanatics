    ...
    return (
        <div className="container my-10">
            <div className="flex flex-col justify-center items-center space-y-12">
                <h3 className="heading-3 relative">PRICING
                ...
                {/* Card */}
                <div className="flex flex-col justify-center items-center bg-[#2E2E30] md:w-[410px] rounded-2xl py-10 space-y-7">
                    <p className="para-medium">Gold</p>
                    <div className="h-[88px] w-[88px] bg-primary rounded-full flex justify-center items-center"><img src={cardIcon} alt="cardIcon" /></div>
                    ...
                    <button className="bg-primary px-5 py-3 rounded-lg">Select a Plan <MoveRight className="ms-1 inline"/></button>
                </div>

                <p className="para-medium text-center">All prices are in EUR except for Switzerland, which uses CHF.</p>
            </div>
        </div>
    )
}
