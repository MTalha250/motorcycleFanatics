  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="para-medium text-primary italic !font-medium bg-white px-2 py-1 rounded-[3px]">This area got <span className="font-bold">{Math.floor(100 + Math.random() * 900)}</span> seraches in the last 7 days</p>
